...
class TestPrimeFactor(TestCase):
    ...
    def test_prime_test_of_3(self):
        self.assertEqual([3], self.prime_factor.of(3))

    def test_prime_test_of_4(self):
        self.assertEqual([2, 2], self.prime_factor.of(4))

    def test_prime_test_of_6(self):
        self.assertEqual([2, 3], self.prime_factor.of(6))

    def test_prime_test_of_9(self):
        self.assertEqual([3, 3], self.prime_factor.of(3))
